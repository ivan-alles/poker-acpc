...
namespace ai.pkr.stdpoker.nunit.ref_evaluator
{
    ...
    public partial class RefEvaluator : IComparable
    {
        ...
        public RefEvaluator(string pocket, string board)
        {
#if DEBUG
        ...
        public static ulong ParseHand(string hand, ref int cards)
        {
            ...
            if (!RefEvaluator.ValidateHand(hand)) throw new ArgumentException("Bad hand definition");
#endif
            // Parse the hand
            cards = 0;
            for (int card = NextCard(hand, ref index); card >= 0; card = NextCard(hand, ref index))
            {
                handmask |= CardMasksTable[card];
                cards++;
            }
            return handmask;
        }
       ...
       /// <returns></returns>
        ...
        {
            int cards = 0;
            handmask = RefEvaluator.ParseHand(PocketCards, Board, ref cards);
            handval = RefEvaluator.Evaluate(handmask, cards);
        }
        ...
        public string PocketCards
        {
            ...
            set
            {
                ...
                if (value.Trim().Length <= 0 || !RefEvaluator.ValidateHand(value))
                    throw new ArgumentNullException("value");
#endif
        ...
        public string Board
        {
            ...
            {
#if DEBUG
                if (value == null || value.Trim().Length <= 0 || !RefEvaluator.ValidateHand(value))
                    throw new ArgumentNullException("value");
#endif
                board = value;
                UpdateHandMask();
        ...
        public static string MaskToString(ulong mask)
        {
            ...
            for (int i = 51; i >= 0; i--)
            {
                ...
                if (((bit) & mask) != 0)
                {
                    ...
                    builder.Append(RefEvaluator.CardTable[i]);
                    count++;
                }
            }
        ...
        {
            return Evaluate(RefEvaluator.ParseHand(hand));
        }
        ...
        /// <exclude/>
        public static readonly int SPADE_OFFSET = 16 * Spades;
        /// <exclude/>
        public static readonly int CLUB_OFFSET = 16 * Clubs;
        /// <exclude/>
        public static readonly int DIAMOND_OFFSET = 16 * Diamonds;
        /// <exclude/>
        public static readonly int HEART_OFFSET = 16 * Hearts;
        ...
        {
            RefEvaluator h = obj as RefEvaluator;
            if (h == null) return -1;
        ...
        {
            return handval == ((RefEvaluator)obj).handval;
        }
        ...
        /// </code>
        /// </example>
        static public bool operator ==(RefEvaluator op1, RefEvaluator op2)
        {
#if DEBUG
