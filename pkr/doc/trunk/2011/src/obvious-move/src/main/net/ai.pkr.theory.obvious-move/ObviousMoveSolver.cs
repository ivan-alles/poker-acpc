...
namespace equilibrium_lp
{
    ...
    /// Was originally copied from ai.pkr.metastrategy.ObviousMoveSolver and adjusted.
    /// </summary>
    /// <para>Algorithm:</para>
    ...
    /// </remarks>
    public class ObviousMoveSolver
    {
        ...
        public Dictionary<int, string> VarHToCard = new Dictionary<int, string>();

        #endregion

        #region Public methods

        public ObviousMoveSolver()
        {
