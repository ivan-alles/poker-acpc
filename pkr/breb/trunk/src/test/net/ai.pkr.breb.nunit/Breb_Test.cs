...
namespace ai.pkr.breb.nunit
{
    /// <summary>
    /// Unit tests for FictitiousPlayMc. 
    /// </summary>
    [TestFixture]
    public class Breb_Test
    {
        ...
        {
            var testParams = new TestParams(this, "kuhn2.gamedef.xml", null, 0.001);
        ...
        {
            var testParams = new TestParams(this, "ocp.gamedef.xml", null, 0.001);
            SolveAndVerifyVerifySolution(testParams, false, false, new int[] { 100, -1 }, null);
        }
        /*
        [Test]
 ...
 * */
        ...
        */
        ...
        delegate void ConfigureSolver(Breb solver);
