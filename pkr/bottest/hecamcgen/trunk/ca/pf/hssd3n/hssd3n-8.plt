...
set title "8 preflop buckets by normalized HS SD3." 
set xlabel "value" 
...
plot  'hssd3n.txt' using  2:3 with circles, '' using  2:3:1 with labels font "Helvetica,7" left offset 1,0, 'centers-8.txt' using 1:2:(0.005) with circles
