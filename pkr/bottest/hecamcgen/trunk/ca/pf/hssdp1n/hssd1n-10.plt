...
set title "10 preflop buckets by normalized HS SD1." 
set xlabel "value" 
...
plot  'hssd1n.txt' using  2:3 with circles, '' using  2:3:1 with labels font "Helvetica,7" left offset 1,0, 'centers-10.txt' using 1:2:(0.005) with circles
