...
{
    /// <summary>
    /// Unit tests for HsRangeAdaptiveCa. 
    /// </summary>
    [TestFixture]
    public class HsRangeAdaptiveCa_Test
    {
        #region Tests
        ...
        public void Test_GetBucket()
        {
            ...
            Assert.LessOrEqual(b.GetAbstractCard(hand, hand.Length), 7);
            hand = dd.GetIndexes("2c 3d As Ks Qh");
            Assert.AreEqual(0, b.GetAbstractCard(hand, hand.Length));

            // Turn
            hand = dd.GetIndexes("Ac Ah As Ad 2h 2d");
            Assert.Less(b.GetAbstractCard(hand, hand.Length), 6);
            ...
            Assert.Less(b.GetAbstractCard(hand, hand.Length), 5);
        ...
        HsRangeAdaptiveCa CalculateHsRangeCa(string minBucketCounts, string maxBucketCounts, string clusterSizes, int[] samplesCount, bool isVerbose)
        {
            ...
            HsRangeAdaptiveCa ca = new HsRangeAdaptiveCa(parameters);
            ...
            HsRangeAdaptiveCa ca1 = new HsRangeAdaptiveCa(parameters);
            return ca1;
        }
        ...
        private Props GetParams(string minBucketCounts, string maxBucketCounts, string clusterSizes)
        {
            Props p = new string[]
                          {
                            "TypeName", typeof(HsRangeAdaptiveCa).AssemblyQualifiedName,
                            "AssemblyFileName", "",
